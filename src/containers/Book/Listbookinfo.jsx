...
export const Listbookinfo = (props) => {
    const [[datainfo], setDatainfo] = useState(datasach.filter((el)=>{
        return el.id == props.id
    }))
    const [[book], setBook]= useState(datacontent.filter((el)=>{
        return el.id == props.id
    }))
        ...
        <div className='containerListbookinfo'>
            <div className='infobook'>
                <div className='imgbook'>
                   <img src={require(`../../image/${datainfo.address}.jpg`)} />
                </div>
                <div className='listinfo'>
                    ...
                    <ul>
                        <li><p>Tác Giả: {datainfo.author}</p></li>
                        <li><p>Nhà xuất bản: {datainfo.nxb}</p></li>
                        <li><p>Số trang: {datainfo.page}</p></li>
                        <li><p>Ngày phát hành: {datainfo.pulish}</p></li>
